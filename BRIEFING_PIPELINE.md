...
```json
{
  ...
  "week_end": "2026-07-19",
  "events": [
    {"actual": null, "country": "US", "estimate": 3.2, "event": "CPI y/y",
     "impact": "high", "prev": 3.1, "time": "2026-07-15 08:30:00", "unit": "%"}
  ],
  "fetched_at": "2026-07-12T20:30:00+00:00"
}
```
`status`: `ok`(events 채워짐) · `no_key`(FINNHUB_API_KEY 없음) · `401`(키 오류) ·
`403`(플랜 제한 — 위 운영 노트 5번 참고) · 그 외 예외 메시지 문자열. `events`는 이번 주
(월~일, KST) 미국·한국 **고영향(high)** 일정만 담는다(중·저영향은 애초에 필터링됨).
